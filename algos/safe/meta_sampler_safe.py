...
from rllab.sampler import meta_parallel_sampler
...
class MetaBatchSamplerSafe(Sampler):
    ...
    def start_worker(self):
        meta_parallel_sampler.populate_task(self.algo.env, self.algo.policy, scope=self.algo.scope)
